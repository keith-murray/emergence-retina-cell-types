...
class Retinal_NET(nn.Module):
    ...
    def forward(self, x):
        first = F.relu(self.drop_layer(self.temporal_conv(F.pad(self.space_conv(x), self.p1d))))
...
if __name__ == "__main__":
    ...
    torch.save(net.state_dict(), 'Q:\Documents\TDS SuperUROP\\run_1_22_p2\model.pt')
